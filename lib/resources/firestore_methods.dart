...
import 'package:stream/resources/storage_methods.dart';
    ...
    try {
      if (title.isNotEmpty && image != null) {
        if (!((await _firestore
          ...
          showSnackBar(
              context, 'Two Livestreams cannot start at the same time.', true);
        }
      } else {
        showSnackBar(context, 'Please enter all the fields', true);
      }
